            ...
            <div class="ass1-section__list">
              <div class="ass1-section">
                <div class="ass1-section__head">
                  <a href="#" class="ass1-section__avatar ass1-avatar">
                  ...
                  <a href="#" class="ass1-section__link ass1-btn-icon">
                    <i class="icon-Link"></i>
                  </a>
                </div>
              ...
              <div class="ass1-comments">
                ...
                <div class="ass1-comments__section">
                  ...
                  <div class="ass1-comments__content">
                    ...
                    <a href="#" class="ass1-comments__btn-reply ass1-btn-icon">
                      <i class="icon-Reply">Trả lời</i>
                    </a>
                    ...
                    <div class="ass1-comments__info">
                      ...
                      <a href="#" class="ass1-comments__btn-flag ass1-btn-icon">
                        <i class="icon-Flag"></i>
                      </a>
                    </div>
                    <!--comment-->
